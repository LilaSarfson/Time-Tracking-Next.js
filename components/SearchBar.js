    ...
    return(
        ...
        <form>   
            ...
            <div className="flex flex-row justify-center items-center">
                <input type="search" id="default-search" className=" w-2/4 p-4 pl-10 text-sm text-gray-900 bg-gray-50 border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search Mockups, Logos..." required/>
